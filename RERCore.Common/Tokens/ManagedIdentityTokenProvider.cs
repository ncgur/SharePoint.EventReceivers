...
{
    /// <summary>
    /// https://pnp.github.io/pnpcore/demos/Demo.AzFunction.ManagedIdentity/README.html
    /// </summary>
    public class ManagedIdentityTokenProvider : IAuthenticationProvider
    {
        ...
        {
            if (string.Equals(resourceUri.Host,"graph.microsoft.com", StringComparison.OrdinalIgnoreCase))
            {
